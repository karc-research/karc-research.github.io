const translations = {
  ...
  'dashboard.welcome': { en: 'Welcome back', ko: '환영합니다' },
  'dashboard.recentActivity': { en: 'Recent Activity', ko: '최근 활동' },
  'dashboard.noActivity': { en: 'No recent activity', ko: '최근 활동이 없습니다' },
  'dashboard.timeAgo': { en: 'ago', ko: '전' },

  // Variants
  'variants.title': { en: 'Variants Database', ko: '변이 데이터베이스' },
  'variants.desc': { en: 'ASD-related genetic variant database', ko: 'ASD 관련 유전 변이 데이터베이스' },
  'variants.addVariant': { en: 'Add Variant', ko: '변이 추가' },
  'variants.uploadExcel': { en: 'Upload Excel', ko: 'Excel 업로드' },
  'variants.downloadTemplate': { en: 'Download Template', ko: '양식 다운로드' },
  'variants.search': { en: 'Search gene or variant...', ko: '유전자 또는 변이 검색...' },
  'variants.allRanks': { en: 'All Ranks', ko: '모든 등급' },
  'variants.allStatus': { en: 'All Status', ko: '모든 상태' },
  'variants.gene': { en: 'Gene', ko: '유전자' },
  'variants.variant': { en: 'Variant', ko: '변이' },
  'variants.rank': { en: 'Rank', ko: '등급' },
  'variants.sampleId': { en: 'Sample ID', ko: '샘플 ID' },
  'variants.genomicPos': { en: 'Genomic Position', ko: '유전체 위치' },
  'variants.proteinChange': { en: 'Protein Change', ko: '단백질 변이' },
  'variants.consequence': { en: 'Consequence', ko: '변이 효과' },
  'variants.transcript': { en: 'Transcript', ko: '전사체' },
  'variants.chromosome': { en: 'Chromosome', ko: '염색체' },
  'variants.position': { en: 'Position', ko: '위치' },
  'variants.inheritance': { en: 'Inheritance', ko: '유전 방식' },
  'variants.notes': { en: 'Notes', ko: '비고' },
  'variants.previous': { en: 'Previous', ko: '이전' },
  'variants.next': { en: 'Next', ko: '다음' },
  'variants.edit': { en: 'Edit', ko: '수정' },
  'variants.delete': { en: 'Delete', ko: '삭제' },
  'variants.save': { en: 'Save', ko: '저장' },
  'variants.cancel': { en: 'Cancel', ko: '취소' },
  'variants.confirmDelete': { en: 'Are you sure you want to delete this variant?', ko: '이 변이를 삭제하시겠습니까?' },
  'variants.uploadSuccess': { en: 'Successfully uploaded', ko: '업로드 성공' },
  'variants.uploadFail': { en: 'Failed to upload', ko: '업로드 실패' },
  'variants.rows': { en: 'rows', ko: '행' },
  'variants.status': { en: 'Status', ko: '상태' },
  'variants.status.available': { en: 'Available', ko: '대기' },
  'variants.status.requested': { en: 'Requested', ko: '요청됨' },
  'variants.status.in_progress': { en: 'In Progress', ko: '진행 중' },
  'variants.status.completed': { en: 'Completed', ko: '완료' },
  'variants.addedBy': { en: 'Added by', ko: '등록자' },
  'variants.comments': { en: 'Comments', ko: '코멘트' },
  'variants.date': { en: 'Date', ko: '등록일' },

  // Reports
  'reports.title': { en: 'Reports', ko: '리포트' },
  'reports.desc': { en: 'Analysis reports and research results', ko: '분석 리포트 및 연구 결과 열람' },
  'reports.addReport': { en: 'Add Report', ko: '리포트 추가' },
  'reports.reportTitle': { en: 'Title', ko: '제목' },
  'reports.type': { en: 'Type', ko: '유형' },
  'reports.status': { en: 'Status', ko: '상태' },
  'reports.summary': { en: 'Summary', ko: '요약' },
  'reports.file': { en: 'File', ko: '파일' },
  'reports.author': { en: 'Author', ko: '작성자' },
  'reports.date': { en: 'Date', ko: '날짜' },
  'reports.download': { en: 'Download', ko: '다운로드' },
  'reports.draft': { en: 'Draft', ko: '초안' },
  'reports.inReview': { en: 'In Review', ko: '검토 중' },
  'reports.published': { en: 'Published', ko: '게시됨' },
  'reports.wgsAnalysis': { en: 'WGS Analysis', ko: 'WGS 분석' },
  'reports.wesAnalysis': { en: 'WES Analysis', ko: 'WES 분석' },
  'reports.clinicalSummary': { en: 'Clinical Summary', ko: '임상 요약' },
  'reports.statistical': { en: 'Statistical Analysis', ko: '통계 분석' },
  'reports.functional': { en: 'Functional Study', ko: '기능 연구' },
  'reports.save': { en: 'Save', ko: '저장' },
  'reports.cancel': { en: 'Cancel', ko: '취소' },
  'reports.edit': { en: 'Edit', ko: '수정' },
  'reports.delete': { en: 'Delete', ko: '삭제' },
  'reports.noReports': { en: 'No reports yet', ko: '리포트가 없습니다' },

  // Researchers
  'researchers.title': { en: 'Researchers', ko: '연구자' },
  'researchers.desc': { en: 'K-ARC researcher network', ko: 'K-ARC 공동연구자 네트워크' },
  'researchers.institution': { en: 'Institution', ko: '소속' },
  'researchers.expertise': { en: 'Expertise', ko: '전문 분야' },
  'researchers.noResearchers': { en: 'No researchers found', ko: '연구자가 없습니다' },

  // Profile
  'profile.title': { en: 'My Profile', ko: '내 프로필' },
  'profile.fullName': { en: 'Full Name', ko: '이름' },
  'profile.email': { en: 'Email', ko: '이메일' },
  'profile.institution': { en: 'Institution', ko: '소속 기관' },
  'profile.expertise': { en: 'Expertise', ko: '전문 분야' },
  'profile.save': { en: 'Save Changes', ko: '변경 사항 저장' },
  'profile.saved': { en: 'Profile saved successfully', ko: '프로필이 저장되었습니다' },
  'profile.saving': { en: 'Saving...', ko: '저장 중...' },

  // Stats
  'stats.variants': { en: 'Total Variants', ko: '총 변이' },
  'stats.researchers': { en: 'Researchers', ko: '연구자' },
  'stats.reports': { en: 'Reports', ko: '리포트' },
  'stats.families': { en: 'Families', ko: '가족' },

  // Announcements
  'announcements.title': { en: 'Announcements', ko: '공지사항' },
  'announcements.desc': { en: 'Team announcements and notices', ko: '팀 공지사항 및 안내' },
  'announcements.add': { en: 'New Announcement', ko: '공지 작성' },
  'announcements.edit': { en: 'Edit', ko: '수정' },
  'announcements.delete': { en: 'Delete', ko: '삭제' },
  'announcements.save': { en: 'Save', ko: '저장' },
  'announcements.cancel': { en: 'Cancel', ko: '취소' },
  'announcements.announcementTitle': { en: 'Title', ko: '제목' },
  'announcements.body': { en: 'Content', ko: '내용' },
  'announcements.pinned': { en: 'Pinned', ko: '고정' },
  ...
  'comments.placeholder': { en: 'Write a comment... (Ctrl+Enter to send)', ko: '코멘트를 입력하세요... (Ctrl+Enter로 전송)' },
