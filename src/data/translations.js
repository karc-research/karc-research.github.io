const translations = {
  ...
  'variants.uploadCsv': { en: 'Upload CSV', ko: 'CSV 업로드' },
  'variants.search': { en: 'Search gene or variant...', ko: '유전자 또는 변이 검색...' },
  'variants.allTypes': { en: 'All Types', ko: '모든 유형' },
  'variants.allSignificance': { en: 'All Significance', ko: '모든 유의성' },
  'variants.gene': { en: 'Gene', ko: '유전자' },
  'variants.variant': { en: 'Variant', ko: '변이' },
  'variants.type': { en: 'Type', ko: '유형' },
  'variants.significance': { en: 'Significance', ko: '유의성' },
  'variants.families': { en: 'Families', ko: '가족 수' },
  ...
  'variants.showing': { en: 'Showing', ko: '' },
  'variants.of': { en: 'of', ko: '/' },
  'variants.variants': { en: 'variants', ko: '개 변이' },
  ...
  'variants.csvRequiredCols': { en: 'Required columns: gene, variant, type, significance', ko: '필수 컬럼: gene, variant, type, significance' },
  ...
  'variants.actions': { en: 'Actions', ko: '관리' },
